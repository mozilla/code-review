...
def test_baseline(mock_config, mock_revision, mock_workflow, mock_backend, mock_hgmo):
    ...
    assert check_stats(
        [
            ...
            ("code-review.issues", "source-test-mozlint-analyzer-B", 0),
            ("code-review.issues.publishable", "source-test-mozlint-analyzer-B", 0),
            ("code-review.issues.paths", "source-test-mozlint-analyzer-B", 0),
